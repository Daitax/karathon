...
class Notification(models.Model):
    ...
    def task_today(participant, datetime, task):
        ...
        format_date = datetime.strftime('%d') + ' ' + print_month_ru(datetime.strftime('%m')) + ' ' + \
                      datetime.strftime('%Y') + ' г.'
